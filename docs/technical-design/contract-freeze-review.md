...
- The current fifty package tests, typecheck, build, schema export check, forty-nine generated HTML pages, seventeen bounded semantic vectors in TypeScript/Python and four valid/three rejected canonical vectors in TypeScript/Python pass. These are bounded fixtures, not a completeness claim.
